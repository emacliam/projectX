          ...
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-full px-3 mb-6">
              ...
              <div class="flex-shrink w-full inline-block">
                <select
                  class="block appearance-none text-gray-600 w-full bg-white border border-gray-400 shadow-inner px-4 py-2 pr-8 rounded placeholder-black"
                  v-model="Btype"
                >
            ...
            <div class="flex items-center justify-between mt-4">
              <div class="w-full md:w-1/2 px-3 mb-6">
                ...
                >
                <input
                  class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none font-medium focus:border-gray-500 placeholder-black"
                  type="text"
            ...
            <div class="w-full md:w-full px-3 mb-6">
              ...
              >
              <textarea
                class="bg-gray-100 rounded-md border leading-normal resize-none w-full h-20 py-2 px-3 shadow-inner border border-gray-400 font-medium focus:outline-none focus:bg-white placeholder-black"
            ...
            <div class="flex justify-end">
              <span
                class="appearance-none bg-gray-200 text-gray-900 px-2 py-1 shadow-sm border border-gray-400 rounded-md mr-3 cursor-pointer"
                @click="send"
                >save changes</span
              >
            </div>
